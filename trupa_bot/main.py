...
if not os.path.exists("gold_ppo_model_retrained.zip"):
    gdown.download(id="1K3P1QHgELOIFfOYH9Ht70LBvX2VLU1Do", output="gold_ppo_model_retrained.zip", quiet=False)
    from zipfile import ZipFile
    with ZipFile("gold_ppo_model_retrained.zip", 'r') as zip_ref:
        zip_ref.extractall(".")

if not os.path.exists("vec_normalize.pkl"):
    gdown.download(id="1j7O8LtMs0gqq-R1Y61Mr5N3WDXwPMFTe", output="vec_normalize.pkl", quiet=False)
